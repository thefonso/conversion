        ...
        <div className="d-flex">
          <div id={"products-purchased"} className="card">
            <div className="card-body">
              <div className="d-flex">
                <h6 className="card-title mr-auto">
                  {title} <span className={"gray"}>- {quote}</span>
                </h6>
                <Button
              ...
              <div className="d-flex mid-row">
                ...
                <ButtonGroup aria-label="Basic dropdown">
                  <Dropdown as={ButtonGroup}>
                    <Button
                      variant="outline-dark"
                      className="category-dd-2 btn btn-sm btn-outline-dark"
                    >
                      is one of
                    </Button>
                ...
                <div className="btn-group">
                  <button
                    className="category-dd-3 btn btn-outline-dark btn-sm"
                    type="button"
                  >
                    <span>Shoes</span>
                  </button>
